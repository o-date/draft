## What is Web Mapping?
A web map is a geographic visualization that is supported by computational infrastructures. This form of mapping is fundamentally *powered* by the Web <a href="http://www.axismaps.com/guide/web/what-is-a-web-map/">(Axismap, 2018)</a>. It should come as no surprise that the ubiquity of web maps correlates with the development of Web 2.0, a marked transformation in the way that that we engage with the Internet [@Aced2013].
...
Below are examples in archaeology that use Leaflet that you can try out, and that have repositories that you can fork for you own projects:
