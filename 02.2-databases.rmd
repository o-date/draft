...
If your application for storing or serving up data runs on the web, your SQL back end is likely something like MySOL or PosgreSQL.
...
```
   Standard Jet DB    µnb`	ÂUé©gr@? œ~Ÿÿ…š1Åyºí0¼ßÌcÙäÃŸFûŠ¼N×_ì7àœú—ú(æBŠ`0{6¤Öß±&PCž±3eÅy[Ã|*×|™˜ý¨SÖÁ\´„f_•øÐ‰$…gÆ'DÒîÏeíÿÇF¡xíé-bÔT  4.0   
```
*Table 2.2.1. Opening a binary database file as text. Not good!*
